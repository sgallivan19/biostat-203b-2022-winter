...
boxplot(lab_box$values ~ lab_box$label, las = 2, xlab = " ", ylab = "values")
```
...
boxplot(chart_box$values ~ chart_box$label, 
        xlab = "measurement", ylab = "values (mixed units)", 
        ylim = c(0, 300), par(cex.axis = 0.37))
```
