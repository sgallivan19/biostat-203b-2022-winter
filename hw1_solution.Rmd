...
**Solution**
The output is the last 5 lines of the first 20 lines in the file. "$1" refers to the .txt file, "$2" refers to 20 and "$3" refers to 5. They are the inputs in this middle.sh function. 
