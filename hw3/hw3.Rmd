...
icu_cohort <- icustays_tble %>% 
  ...
  mutate(thirty_day_mort = ifelse(is.na(dod), "No", 
                                  ifelse((year(dod) - year(admittime)) <= 30, 
                                         "Yes", "No")))
#  mutate(thirty_day_mort = "No")
#icu_cohort$thirty_day_mort <- ifelse(is.na(icu_cohort$deathtime), 
#         "No", ifelse(lubridate::year(icu_cohort$deathtime) - 
#         lubridate::year(icu_cohort$admittime) <= 30, "Yes", "No"))
